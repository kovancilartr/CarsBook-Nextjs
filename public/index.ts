...
export const sliderData: SliderProps[] = [
  {
    label: "Discover the most beautiful places around the globe",
    description: "Travel with luxury and comfort on your next trip. Experience thrilling adventures and activities.",
    image: "/slider/1.png", 
    href: "/", 
  },
  {
